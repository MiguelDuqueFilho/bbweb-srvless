module.exports = {
  EVENT_STATUS: [
    {
      id: 1,
      eventStatusName: 'Inicial',
    },
    {
      id: 2,
      eventStatusName: 'Aguardando Contrato',
    },
    {
      id: 3,
      eventStatusName: 'Contratado',
    },
    {
      id: 4,
      eventStatusName: 'Em Andamento',
    },
    {
      id: 5,
      eventStatusName: 'Pendência',
    },
    {
      id: 6,
      eventStatusName: 'Concluído',
    },
    {
      id: 7,
      eventStatusName: 'Cancelado',
    },
  ],
  EVENT_TYPES: [
    {
      id: 1,
      eventTypeName: 'Assessoria do Dia',
      eventTypeResumo:
        'Nossa Assessoria do Dia foi pensada com muito carinho para atender os noivos no dia do seu evento.',
      eventTypeIcon: 'GiPartyFlags',
      eventTypeUrl: '/advice_day',
      eventTypeShow: false,
    },
    {
      id: 2,
      eventTypeName: 'Assessoria Final',
      eventTypeResumo:
      ...
      eventTypeIcon: 'GiBigDiamondRing',
      eventTypeShow: 1,
      eventTypeUrl: '/advice_last',
    },
    {
      id: 3,
      eventTypeName: 'Assessoria Completa',
      eventTypeResumo:
      ...
      eventTypeIcon: 'GiQueenCrown',
      eventTypeShow: 1,
      eventTypeUrl: '/advice_complete',
    },
    {
      id: 4,
      eventTypeName: 'Consultoria',
      eventTypeResumo:
      ...
      eventTypeIcon: 'GoBook',
      eventTypeShow: 1,
      eventTypeUrl: '/advice_consulting',
    },
    {
      id: 5,
      eventTypeName: 'Assessoria Pedido de Casamento',
      eventTypeResumo:
