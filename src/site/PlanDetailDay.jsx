            ...
            <div className="row">
              <div className="col-md-12 ml-auto mr-auto">
                ...
                <p className="text-justify">
                  Nossa Assessoria do Dia foi pensada com muito carinho para
                  atender os noivos no dia do seu evento. Mas claro que, para
                  tudo sair perfeito como o planejado, precisamos entender sobre
                  seu casamento e tomar conta de alguns detalhes
                  importantíssimos! Nós orientamos o casal de 1 mês à 20 dias
                  antes sobre alguns cuidados que precisam ter e nos inteiramos
                  de todo o evento, desenvolvendo junto com o casal todos
                  cronogramas necessários. No Grande Dia estaremos desde o
                  primeiro horário da montagem para garantir o perfeito
